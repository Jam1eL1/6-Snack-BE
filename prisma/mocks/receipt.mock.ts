export const receiptMockData = [
  // Order 1 Receipts (user-1: Chips Ahoy 2x + Hershey's 3x)
  {
    ...
    price: 349,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/chips_ahoy.png",
    quantity: 2,
  ...
  },
  {
    ...
    price: 149,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/hersheys_milk_chocolate.png",
    quantity: 3,
    createdAt: new Date("2026-03-15T10:30:00Z"),
  },
  ...
  // Order 2 Receipts (user-2: Coca-Cola 2x + Tropicana 1x)
  {
    ...
    price: 199,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/coca_cola_500ml.png",
    quantity: 2,
  ...
  },
  {
    ...
    price: 279,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/tropicana_orange_juice.png",
    quantity: 1,
    createdAt: new Date("2026-04-01T14:15:00Z"),
  },
  ...
  // Order 3 Receipts (user-3: Red Bull 2x + Ramen 3x)
  {
    ...
    price: 379,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/red_bull.png",
    quantity: 2,
  ...
  },
  {
    ...
    price: 129,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/maruchan_chicken.png",
    quantity: 3,
    createdAt: new Date("2026-04-07T09:45:00Z"),
  },
  ...
  // Order 4 Receipts (user-3: Post-it 2x + Pens 5x) - PENDING status
  {
    ...
    price: 349,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/post_it_notes.png",
    quantity: 2,
  ...
  },
  {
    ...
    price: 99,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/bic_pen.png",
    quantity: 5,
    createdAt: new Date("2026-04-12T11:20:00Z"),
  },
  ...
  // Order 6 Receipts (user-4: Lay's 4x + Pepsi 2x) - PENDING
  {
    ...
    price: 249,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/lays_classic.png",
    quantity: 4,
  ...
  },
  {
    ...
    price: 199,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/pepsi_500ml.png",
    quantity: 2,
    createdAt: new Date("2026-05-05T09:10:00Z"),
  },
  ...
  // Order 7 Receipts (user-5: Oreo 2x + Mentos 6x) - PENDING
  {
    ...
    price: 399,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/oreo_double_stuf.png",
    quantity: 2,
  ...
  },
  {
    ...
    price: 129,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/mentos_mint.png",
    quantity: 6,
    createdAt: new Date("2026-05-06T10:20:00Z"),
  },
  ...
  // Order 8 Receipts (user-6: Dixie cups 3x + Kleenex 4x) - PENDING
  {
    ...
    price: 449,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/dixie_paper_cups.png",
    quantity: 3,
  ...
  },
  {
    ...
    price: 299,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/kleenex_tissues.png",
    quantity: 4,
    createdAt: new Date("2026-05-07T11:30:00Z"),
  },
  ...
  // Order 9 Receipts (user-8: Starbucks espresso 4x + water 12x) - PENDING
  {
    ...
    price: 349,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/starbucks_doubleshot.png",
    quantity: 4,
  ...
  },
  {
    ...
    price: 119,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/nestle_pure_life.png",
    quantity: 12,
    createdAt: new Date("2026-05-08T12:40:00Z"),
  },
  ...
  // Order 10 Receipts (user-4: Monster 2x + Top Ramen 5x) - APPROVED
  {
    ...
    price: 349,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/monster_energy.png",
    quantity: 2,
  ...
  },
  {
    ...
    price: 139,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/nissin_top_ramen_beef.png",
    quantity: 5,
    createdAt: new Date("2026-05-01T08:15:00Z"),
  },
  ...
  // Order 11 Receipts (user-5: Lindt 2x + Perrier 6x) - APPROVED
  {
    ...
    price: 399,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/lindt_dark_70.png",
    quantity: 2,
  ...
  },
  {
    ...
    price: 179,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/perrier_lime.png",
    quantity: 6,
    createdAt: new Date("2026-05-02T14:25:00Z"),
  },
  ...
  // Order 12 Receipts (user-6: coffee beans 1x + cups 2x) - REJECTED
  {
    ...
    price: 1799,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/starbucks_medium_roast_whole_beans.png",
    quantity: 1,
  ...
  // Order 13 Receipts (user-3: cup noodles 6x + LaCroix 6x) - CANCELED
  {
    ...
    price: 159,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/nissin_cup_noodles.png",
    quantity: 6,
  ...
  },
  {
    ...
    price: 149,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/lacroix_lemon.png",
    quantity: 6,
    createdAt: new Date("2026-05-04T15:45:00Z"),
  },
  ...
  // Order 16 Receipts (user-9: Haribo 5x + Aquafina 8x) - APPROVED
  {
    ...
    price: 229,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/haribo_goldbears.png",
    quantity: 5,
  ...
  },
  {
    ...
    price: 119,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/aquafina_500ml.png",
    quantity: 8,
    createdAt: new Date("2026-05-02T09:45:00Z"),
  },
  ...
  // Order 17 Receipts (user-10: Doritos 4x + Red Bull 2x) - INSTANT_APPROVED
  {
    ...
    price: 299,
    imageUrl: "https://snack-s3-production.s3.us-west-2.amazonaws.com/products/doritos_nacho_cheese.png",
    quantity: 4,
